...
import { ArrowLeft, HelpCircle, ChevronDown, ChevronUp, Search, Home, User, FileText, Shield } from 'lucide-react';
            ...
            <main className="max-w-5xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        ...
                        <Link to="/contact" className="text-orange-700 underline decoration-2 underline-offset-4 hover:text-orange-800">Contact us</Link>.
                    </p>
                </div>
                    ...
                    {filteredFaqs.length === 0 ? (
                        ...
                        filteredFaqs.map(faq => (
                            ...
                            >
                                <button
                                    type="button"
                                    aria-expanded={Boolean(openItems[faq.id])}
