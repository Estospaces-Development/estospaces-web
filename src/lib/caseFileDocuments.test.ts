...
test('reusable document filtering keeps only documents relevant to the request', () => {
    const documents = [
        { id: 'doc-1', document: { document_category: 'identity', document_type: 'government_id' } },
        { id: 'doc-2', document: { document_category: 'financial', document_type: 'proof_of_funds' } },
        { id: 'doc-3', document: { document_category: 'transactional', document_type: 'transaction_document' } },
    ];
...
test('reusable document filtering accepts top-level user-document payloads from the case-file API', () => {
    const documents = [
        { id: 'doc-1', document_category: 'address', document_type: 'address_proof' },
        { id: 'doc-2', document_category: 'identity', document_type: 'government_id' },
    ];
