...
const DEFAULT_DESCRIPTION = 'Premium property platform connecting buyers, sellers, and brokers across supported locations. Find your dream property with Estospaces.';
...
export const pageMetadata = {
    ...
    userSearch: generateMetadata({ title: 'Property Search', path: '/user/search', description: 'Search verified property listings across supported locations.' }),
