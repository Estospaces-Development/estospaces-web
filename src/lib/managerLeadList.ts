...
export const mapBrokerRequestOfferToManagerLead = (request: BrokerRequestRecord): Lead => {
  ...
  return {
    ...
    response_deadline_at: request.broker_offer_expires_at ?? request.response_deadline_at,
    ...
    sla_deadline: request.broker_offer_expires_at ?? request.response_deadline_at,
