        ...
        <div className="w-full">
            ...
            <div className={`relative flex items-center ${isFocused ? 'ring-2 ring-primary ring-offset-1 rounded-lg' : ''}`}>
                <input
                    ...
                    disabled={disabled}
                    className={`themed-number-input w-full px-4 py-3 pr-12 bg-gray-50 dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-900 dark:text-white transition-all hover:border-gray-300 dark:hover:border-gray-600 ${error ? 'border-red-500 focus:ring-red-500' : 'border-gray-100 dark:border-gray-700'
