...
const KPICard = ({ title, value, change, icon: Icon, iconColor, trendColor }: KPICardProps) => {
    return (
        <div className="bg-white dark:bg-black rounded-lg shadow-sm p-6 border border-gray-100 dark:border-gray-800 relative overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:brightness-110 dark:hover:brightness-150">
