...
test("fast-track customization drawer renders above manager header through a body portal", () => {
  ...
  assert.match(source, /role="dialog"/);
  assert.match(source, /aria-modal="true"/);
  assert.match(source, /fixed bottom-0 right-0 isolate z-\[2147483647\] flex justify-end overflow-hidden bg-transparent/);
  ...
  assert.match(source, /flex-1 cursor-default bg-gray-950\/25 dark:bg-gray-950\/55/);
