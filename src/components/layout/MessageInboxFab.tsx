...
export default function MessageInboxFab() {
    ...
    return (
        <button
            ...
            className="fixed bottom-6 right-6 z-40 hidden min-h-12 items-center gap-3 rounded-full bg-orange-500 px-5 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:scale-[1.02] hover:bg-orange-600 hover:shadow-xl hover:shadow-orange-500/30 md:inline-flex"
