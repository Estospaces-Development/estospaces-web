                ...
                <div className="mb-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="px-5 py-3 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border dark:border-gray-700 flex items-center gap-3">
                ...
                {activeTab === 'overview' && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border dark:border-gray-700 group hover:scale-[1.02] transition-all">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <h3 className="text-3xl font-black text-gray-900 dark:text-white">£4,850</h3>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border dark:border-gray-700 group hover:scale-[1.02] transition-all">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <h3 className="text-3xl font-black text-orange-500">£1,200</h3>
                                    </div>
                                </div>
                            ...
                            <div className="bg-gray-900 dark:bg-white rounded-3xl p-8 shadow-2xl overflow-hidden relative group hover:scale-[1.02] transition-all">
                                ...
                                <div className="relative z-10 h-full flex flex-col justify-between">
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-black text-white dark:text-gray-900">£1,800</h3>
                                        <p className="text-gray-400 dark:text-gray-500 text-sm font-bold mt-1">Rent • 1st April 2024</p>
                                    </div>
                ...
                {activeTab === 'history' && (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border dark:border-gray-700 overflow-hidden">
                            <div className="px-8 py-6 border-b dark:border-gray-700 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gray-50/50 dark:bg-gray-900/20">
                                    ...
                                    {['all', 'rent', 'utilities'].map((f) => (
                                        <button
                                            ...
                                            className={`px-5 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${historyFilter === f
                                                    ...
                                                    : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-400 border dark:border-gray-600 shadow-sm'
                                                }`}
                                        >
                                            {f}
                                        </button>
                        ...
                        <div className="max-w-2xl mx-auto space-y-6">
                            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border dark:border-gray-700 p-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border dark:border-gray-700 group transition-all">
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border dark:border-gray-700 p-8 flex flex-col items-center justify-center text-center py-16">
