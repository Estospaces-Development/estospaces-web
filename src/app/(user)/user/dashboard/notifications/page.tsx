            ...
            <div className="max-w-4xl mx-auto px-4 lg:px-6 mt-8">
                ...
                {loading ? (
                    <div className="space-y-4">
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className="h-24 bg-white dark:bg-gray-800 rounded-2xl animate-pulse border dark:border-gray-700" />
                        ))}
                    </div>
                                ...
                                <div key={group} className="space-y-3">
                                    ...
                                    <div className="space-y-3">
                                        {items.map(notification => (
                                            <div
                                                key={notification.id}
                                                className={`group relative flex items-center gap-4 p-4 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-2xl transition-all hover:shadow-xl hover:-translate-y-0.5 ${!notification.read ? 'border-orange-200 dark:border-orange-900/30' : ''}`}
                                            >
                                                <input
                                                    type="checkbox"
                                                ...
                                                <div
                                                    className={`p-3 rounded-xl flex-shrink-0 border dark:border-gray-700 ${getNotificationColor(notification.type)}`}
