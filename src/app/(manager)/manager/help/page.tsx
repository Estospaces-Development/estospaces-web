...
export default function ManagerHelpPage() {
    ...
    return (
        <div className="space-y-6 font-sans">
            <div>
                <div className="mb-4">
                    <button onClick={() => router.back()} className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
