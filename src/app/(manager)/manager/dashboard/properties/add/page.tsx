...
export default function AddPropertyPage({ params }: { params?: { id?: string } }) {
    const router = useRouter();
    const paramsHook = useParams();
    const idValue = params?.id || (paramsHook?.id as string);
    ...
    const handleSaveDraft = async () => {
        ...
        try {
            ...
            setTimeout(() => router.push('/manager/dashboard/properties'), 1500);
        } catch (error: any) {
            ...
            <div className="max-w-6xl mx-auto font-sans pb-8">
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-12">
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <button
                            onClick={() => router.push('/manager/dashboard/properties')}
