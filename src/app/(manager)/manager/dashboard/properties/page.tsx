                    ...
                    {tabFilteredProperties.map((property) => (
                        <div key={property.id} className="relative group">
                            ...
                            <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
                                <button
                                    onClick={(e) => { e.stopPropagation(); router.push(`/manager/dashboard/properties/edit/${property.id}`); }}
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {tabFilteredProperties.map((property) => (
                                <tr key={property.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors cursor-pointer" onClick={() => router.push(`/manager/dashboard/properties/${property.id}`)}>
